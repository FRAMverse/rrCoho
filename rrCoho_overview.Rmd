...
lu <- list(
  ...
  rmis_fram_pr_mu = readr::read_csv(
    #unmodified other than field names: 'O:/code/coho/rrterm/MB_Draft_2020/ReferenceFiles_4Rcode/Table1rv_RelLocName_Region_Stock_111319_Hatch.csv'
...
#   drop_na(FisheryID) |> 
#   full_join(
#     read_csv("O:/code/coho/rrterm/MB_Draft_2020/ReferenceFiles_4Rcode/FRAMFisheryID_2_RRTermCANumber.csv") #no duplicate FisheryID, |> count(FRAM_FisheryID) |> filter(n>1)
#     ,
...
#   read_csv('O:/code/coho/rrterm/MB_Draft_2020/ReferenceFiles_4Rcode/Table1rv_RelLocName_Region_Stock_111319_Hatch.csv') |>
...
#   read_csv('O:/code/coho/rrterm/MB_Draft_2020/ReferenceFiles_4Rcode/MU_Data_RRTermDB_072817.csv') |>
...
mb20$cwt_raw <- left_join(
  ...
  #or: "O:/code/coho/rrterm/MB_Draft_2020/Data_ProcessingSteps/Raw_RMIS_CWTQueryData/AllRelease_Data_123021/CSV1601.csv"
  ,
...
# read_csv('O:/code/coho/rrterm/MB_Draft_2020/ReferenceFiles_4Rcode/EditDisCAData_FramCANum_2OldRRTerm_080217.csv') |> 
...
#read_csv("O:/code/coho/rrterm/MB_Draft_2020/Data_ProcessingSteps/Fishery_Method_Files_CWT/END_MSMFisheryMapping_Match3_010322.csv")
...
# #derived from 
# "O:/code/coho/rrterm/MB_Draft_2020/Data_ProcessingSteps/Stock_Method_Files_CWT/Reg1-6AllFisheryCWTRecov_FRAMFisheryStock_010422.csv"
...
#need to sort with AHB exactly what the desired/intented calculation should be
#appears that, for example, the 559 UM-but-tagged Skookum count (cwt_2nd_mark==0000) is being included in the "marked only" denominator




#Access table format, all years...
read_csv("O:/code/coho/rrterm/MB_Draft_2020/Data_ProcessingSteps/PEF_Method_Files/MU_Local_PEF_010422.csv") |> 
  filter(Run_ID == 2020)
#object export with "_Num" and "_Den" fields
read_csv("O:/code/coho/rrterm/MB_Draft_2020/Data_ProcessingSteps/PEF_Method_Files/LocalPEF_Match5sum_010422.csv") |> 
    filter(Run_ID == 2020)



"O:/code/coho/rrterm/MB_Draft_2020/Data_ProcessingSteps/Raw_RMIS_CWTQueryData/AllRelease_Data_123021/CSV1601.csv"
