...
rmis_rr <- mb20$cwt_raw |> 
  ...
  select(
    ...
    estimated_number, cwt_1st_mark,
    brood_year, 
    rearing_type,
    release_location_code, release_location_name, 
    hatchery_location_name = hatchery_location_name.x,
    stock_location_name = stock_location_name.x
    ) |> 
...
#demostrating non-stock aggregation to RRTerm CA
#basically aiming for close to this but by MU_shortname/StockID
rmis_rr |> 
